...
{
    public class MockManga : IAllManga
    {
        private readonly IMangaCategory _categoryManga = new MockCategory();
            ...
            get
            {
                return new List<Manga>
                {
                    new Manga
                    {
                        ...
                        isFavourite = true,
                        available = true,
                        Category  = _categoryManga.AllCategories.First()
                    },
                    new Manga
                    {
                        ...
                        isFavourite = true,
                        available = true,
                        Category  = _categoryManga.AllCategories.Last()
                    },
                    new Manga
                    {
                    ...
                    new Manga
                    {
                        ...
                        isFavourite = false,
                        available = true,
                        Category = _categoryManga.AllCategories.ElementAt(1)
                    }
                };
            }
        }
        public IEnumerable<Manga> getFavManga { get; set; }

        public Manga getObjectManga(int mangaID)
        {
